...
4. איטרטור BFS - סריקת העץ לרוחב (משמאלי לימין) (עובד על עץ כללי).
5. איטרטור DFS - סריקת העץ בעזרת אלגוריתם DFS (עובד על עץ כללי).
6. איטרטור Heap - הפיכת עץ בינארי לערימת מינימום, לקריאה נוספת: <https://he.wikipedia.org/wiki/%D7%A2%D7%A8%D7%99%D7%9E%D7%94_%D7%91%D7%99%D7%A0%D7%90%D7%A8%D7%99%D7%AA> (פה אתם יכולים באלגוריתמים של הספרייה התקנית).
